...
const CONTACT_METHODS = [
  {
    ...
    flag: "/images/logo.png", // Using logo as placeholder if flag missing
      ...
      <main className="pt-32 pb-24">
        ...
        <section className="container mx-auto px-6 mb-20">
          <div className="max-w-4xl">
            ...
            >
              Contact <span className="text-[#FF6347]">us</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              If you have a question, but did not find an answer in our <span className="text-[#0066ff] font-medium cursor-pointer hover:underline">Help Center</span>, please feel free to contact us directly. We are available Monday - Friday, 07:30 am - 02:00 am EEST.
            </motion.p>
          </div>
        </section>
        ...
        <section className="container mx-auto px-6 mb-24">
          <motion.div 
            ...
            className="relative overflow-hidden rounded-[2rem] bg-gradient-to-r from-blue-500 to-blue-700 p-8 md:p-12 text-white flex flex-col md:flex-row items-center justify-between gap-8"
          >
            <div className="flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
              <div className="w-16 h-16 rounded-2xl bg-white flex items-center justify-center text-blue-600 shadow-xl">
                <Mail size={32} />
              </div>
            ...
            <div className="flex flex-col gap-2 text-center md:text-right">
              <p className="text-sm text-blue-100 whitespace-nowrap">For client-related questions: <span className="font-bold text-white hover:underline cursor-pointer">support@mastersync.global</span></p>
              <p className="text-sm text-blue-100 whitespace-nowrap">For legal or licensing matters: <span className="font-bold text-white hover:underline cursor-pointer">info@mastersync.global</span></p>
            </div>
          </motion.div>
        </section>
        ...
        <section className="container mx-auto px-6 mb-24">
            ...
            {CONTACT_METHODS.map((method, idx) => (
              <motion.div
                ...
                className={`p-8 rounded-3xl border transition-all duration-300 group ${
                  method.isUS 
                  ? "bg-neutral-50 dark:bg-neutral-900 border-blue-500/30 shadow-lg" 
          ...
          <div className="mt-12 flex justify-center">
             <button className="bg-blue-500 text-white px-8 py-4 rounded-2xl font-bold flex items-center gap-3 hover:bg-blue-600 transition-all shadow-xl shadow-blue-500/20 active:scale-95">
        ...
        <section className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
               ...
               <div className="p-10 rounded-[2.5rem] bg-neutral-900 dark:bg-neutral-900/80 text-white flex items-center justify-between border border-white/5 shadow-2xl overflow-hidden relative">
                  <div className="relative z-10 flex items-center gap-6">
                    <div className="w-20 h-20 rounded-3xl bg-blue-500 flex items-center justify-center shadow-[0_10px_30px_rgba(59,130,246,0.3)]">
            ...
            <motion.div 
               ...
               className="relative overflow-hidden group cursor-pointer"
            >
               <div className="absolute inset-x-0 bottom-0 h-1 bg-[#FF6347] transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left z-20" />
               <div className="p-10 rounded-[2.5rem] bg-neutral-900 dark:bg-neutral-900/80 text-white flex items-center justify-between border border-white/5 shadow-2xl overflow-hidden relative">
                  <div className="relative z-10 flex items-center gap-6">
                    <div className="w-20 h-20 rounded-3xl bg-[#FF6347] flex items-center justify-center shadow-[0_10px_30px_rgba(255,99,71,0.3)]">
