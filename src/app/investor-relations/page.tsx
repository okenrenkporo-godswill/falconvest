      ...
      <main className="pt-32 pb-24">
        ...
        <section className="container mx-auto px-6 mb-32">
          <div className="max-w-4xl">
            ...
            >
              Investor <span className="text-[#33525c]">Hub.</span>
            </motion.h1>
        ...
        <section className="container mx-auto px-6 mb-32 grid grid-cols-1 md:grid-cols-3 gap-8">
           ...
           <div className="p-10 rounded-[2.5rem] bg-white dark:bg-neutral-900 border border-black/5 dark:border-white/5 relative overflow-hidden group">
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#33525c] mb-2">Total Funding</p>
                 ...
                 {REPORTS.map((report, i) => (
                   <div key={i} className="group p-8 rounded-3xl bg-neutral-50 dark:bg-neutral-900/50 border border-black/5 dark:border-white/5 flex items-center justify-between hover:bg-white dark:hover:bg-neutral-900 transition-all cursor-pointer">
                      <div className="flex items-center gap-6">
                         ...
                         <div>
                            <h4 className="font-bold text-black dark:text-white group-hover:text-[#33525c] transition-colors">{report.title}</h4>
                            <p className="text-[10px] text-neutral-500 font-bold uppercase tracking-widest mt-1">{report.type} • {report.date}</p>
                         </div>
                      </div>
                      <div className="w-10 h-10 rounded-full bg-black/5 dark:bg-white/5 flex items-center justify-center group-hover:bg-[#33525c] group-hover:text-white transition-all">
                         <ArrowRight size={16} />
                      </div>
                   </div>
                 ))}
           ...
           <section className="space-y-12">
              ...
              <div className="space-y-6">
                 {[
                   ...
                   <div key={i} className="flex gap-8 items-start border-l-2 border-[#33525c] pl-8 py-2">
                      <div className="text-[#33525c] font-black text-xl whitespace-nowrap">{ev.date}</div>
                      <div>
