                ...
                <TableBody>
                  {data.map((item) => (
                    <TableRow key={item.id} className="border-b border-black/5 dark:border-white/5 last:border-0 hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
                      ...
                      <TableCell>
                        <span className={`font-mono font-bold transition-colors duration-500 ${lastUpdates[item.id] === true ? 'text-green-500' : lastUpdates[item.id] === false ? 'text-red-500' : 'text-[#FF6347]'}`}>
                          {item.buy.toFixed(5)}
                        </span>
                      </TableCell>
                      <TableCell>
