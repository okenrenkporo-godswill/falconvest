      ...
      <main className="pt-32 pb-24">
        ...
        <section className="container mx-auto px-6 mb-32">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-10">
            ...
            >
              Build the <span className="text-[#FF6347]">Future.</span>
            </motion.h1>
            <motion.p 
            ...
            >
              MasterSync is looking for bold thinkers, fast learners, and obsessed builders who want to redefine global finance together.
            </motion.p>
          </div>
        </section>
        ...
        <section className="bg-neutral-900 overflow-hidden relative py-32 mb-32">
           <div className="container mx-auto px-6 grid md:grid-cols-3 gap-12 text-center">
              <div className="space-y-6">
                 <div className="w-16 h-16 rounded-2xl bg-white/5 flex items-center justify-center text-[#FF6347] mx-auto border border-white/5">
                    <Zap size={32} />
                 </div>
           ...
           <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[#FF6347]/5 rounded-full blur-[150px] -z-0" />
        </section>
        ...
        <section className="container mx-auto px-6">
           <div className="flex flex-col md:flex-row items-end justify-between gap-8 mb-20">
              <div className="space-y-4">
                 ...
                 <p className="text-neutral-500">Find your place in the MasterSync story.</p>
              </div>
              ...
              {JOBS.map((job, i) => (
                ...
                >
                  <div className="flex items-center gap-8 text-center md:text-left">
                    ...
                    <div>
                       <h3 className="text-2xl font-black text-black dark:text-white uppercase group-hover:text-[#FF6347] transition-colors">{job.title}</h3>
                  ...
                  <div className="flex items-center gap-8">
                     ...
                     <div className="w-12 h-12 rounded-full border border-black/5 dark:border-white/10 flex items-center justify-center group-hover:bg-[#FF6347] group-hover:text-white transition-all group-hover:translate-x-2">
                        <ArrowRight size={20} />
                     </div>
                  </div>
                </motion.div>
