      ...
      <div className="max-w-4xl mx-auto">
        <Card>
          <CardBody className="prose dark:prose-invert max-w-none p-8">
            ...
            <p>
              By accessing and using MasterSync, you accept and agree to be bound by the terms
              and provision of this agreement.
            </p>

            <h2>2. Use License</h2>
            <p>
              Permission is granted to temporarily use MasterSync for personal, non-commercial
