        ...
        <section className="container mx-auto px-6 mb-32">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-8">
            <motion.div
              ...
              className="px-4 py-1.5 rounded-full bg-[#33525c]/10 text-[#33525c] text-[10px] font-black uppercase tracking-[0.2em]"
            >
              Our Mission
            </motion.div>
            <motion.h1 
            ...
            >
              Redefining <span className="text-[#33525c] italic">Institutional</span> Trading.
            </motion.h1>
            <motion.p 
            ...
            >
              Falcon was born from a simple realization: that professional-grade tools shouldn't be reserved for elite institutions. We've built a platform that combines bank-level security with the accessibility of modern fintech.
            </motion.p>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {VALUES.map((val, i) => (
              <motion.div 
                ...
                className="p-10 rounded-[2.5rem] bg-white dark:bg-neutral-900 border border-black/5 dark:border-white/5 hover:border-[#33525c]/30 transition-all group"
              >
                <div className="w-14 h-14 rounded-2xl bg-[#33525c]/5 flex items-center justify-center text-[#33525c] mb-8 group-hover:scale-110 transition-transform">
                  <val.icon size={28} />
                </div>
