                   ...
                   <div className="space-y-4">
                      {group.items.map((doc, dIdx) => (
                        <motion.div 
                          ...
                          className="group p-6 rounded-2xl bg-neutral-50 dark:bg-neutral-900 border border-black/5 dark:border-white/5 hover:border-[#33525c]/30 transition-all cursor-pointer flex items-center justify-between"
                        >
                          <div className="flex items-center gap-4">
                             <div className="w-10 h-10 rounded-xl bg-white dark:bg-neutral-800 flex items-center justify-center text-neutral-400 group-hover:text-[#33525c] transition-colors shadow-sm">
                                <FileText size={18} />
                             </div>
                             <div>
                                <h4 className="font-bold text-black dark:text-white text-sm group-hover:text-[#33525c] transition-colors">{doc.title}</h4>
        ...
        <section className="container mx-auto px-6 mt-32">
           <div className="p-16 rounded-[3rem] bg-neutral-950 text-center relative overflow-hidden">
              ...
              <div className="relative z-10 max-w-2xl mx-auto space-y-8">
                 ...
                 <p className="text-neutral-500 italic">Falcon Limited is authorized and regulated by the Financial Services Authority (FSA). We maintain segregated client accounts and industry-standard security protocols for all assets.</p>
