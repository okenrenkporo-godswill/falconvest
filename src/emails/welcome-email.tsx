...
export default function WelcomeEmail({ name, email }: WelcomeEmailProps) {
  return (
    <EmailTemplate preview="Welcome to Falcon - Complete Your KYC Verification">
      <Preview>Welcome to Falcon - Complete Your KYC Verification</Preview>

      <Text style={paragraph}>Hi {name},</Text>

      <Text style={paragraph}>
        Thank you for creating your Falcon account. We're excited to have
