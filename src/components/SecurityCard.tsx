...
export default function SecurityCard() {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white dark:bg-black transition-colors duration-500 overflow-hidden relative">
      {/* Background Ambience */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-4xl bg-[#33525c]/5 rounded-full blur-[120px] pointer-events-none opacity-50" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative z-10 bg-neutral-50 dark:bg-neutral-900/50 border border-black/5 dark:border-white/5 rounded-2xl sm:rounded-[2rem] md:rounded-[3rem] p-5 sm:p-6 md:p-8 lg:p-12 shadow-2xl backdrop-blur-xl">
              <div className="flex items-center gap-3 sm:gap-4 mb-5 sm:mb-6 md:mb-8">
                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl sm:rounded-2xl bg-[#33525c]/10 flex items-center justify-center text-[#33525c]">
              ...
              <div className="space-y-3 sm:space-y-4 md:space-y-6">
                 {[
                   ...
                   <div key={i} className="flex items-center justify-between p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-white dark:bg-black/40 border border-black/5 dark:border-white/5">
                      ...
                      <div className="flex items-center gap-1.5 sm:gap-2 text-[#33525c]">
              ...
              <div className="mt-6 sm:mt-8 md:mt-10 p-4 sm:p-5 md:p-6 rounded-2xl sm:rounded-3xl bg-black dark:bg-[#050505] text-white">
                 <p className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-[#33525c] mb-1 sm:mb-2">{t('securityScore')}</p>
            ...
            <motion.div 
               ...
               className="absolute -top-3 -right-3 sm:-top-4 sm:-right-4 md:-top-6 md:-right-6 p-2.5 sm:p-3 md:p-4 rounded-xl sm:rounded-2xl bg-[#33525c] text-white shadow-2xl z-20 flex items-center gap-2 sm:gap-3"
            >
          ...
          >
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#33525c]/20 bg-[#33525c]/5 mb-4 sm:mb-5 md:mb-6">
                <span className="text-[9px] sm:text-[10px] font-black tracking-widest text-[#33525c] uppercase">{t('safetyFirst')}</span>
              </div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-black dark:text-white tracking-tighter leading-tight mb-4 sm:mb-5 md:mb-6">
                ...
                <span className="text-[#33525c]">{t('headline.suffix')}</span>
              </h2>
