  ...
  return (
      <PhoneFrame>
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute -top-20 -left-20 w-64 h-64 bg-[#33525c]/10 rounded-full blur-3xl animate-pulse"></div>
                <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-[#33525c]/5 rounded-full blur-3xl animate-pulse delay-1000"></div>
            ...
            <AnimatePresence mode="wait">
                ...
                {step === 2 && (
                    ...
                    >
                         ...
                         >
                             <div className="absolute inset-0 bg-[#33525c]/20 blur-2xl rounded-full"></div>
                             <Image 
                    ...
                    >
                        ...
                        >
                            <p className="text-white text-lg font-medium">
                                👋 Hey, Welcome to <span className="text-[#33525c] font-bold">Falcon</span>
                            </p>
                        </motion.div>
                    </motion.div>
                )}
            ...
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-1/3 h-1 bg-neutral-800 rounded-full overflow-hidden">
                <motion.div 
                    className="h-full bg-gradient-to-r from-[#33525c] to-[#33525c]/40"
                    animate={{ width: ["0%", "100%"] }}
