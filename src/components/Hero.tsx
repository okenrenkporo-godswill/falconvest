...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[-20%] left-[-10%] w-[60%] h-[60%] bg-[#01C1D6]/5 rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute bottom-[10%] right-[-5%] w-[40%] h-[40%] bg-[#01C1D6]/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-black/5 dark:border-white/10 bg-black/5 dark:bg-white/5 backdrop-blur-md">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#01C1D6] opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-[#01C1D6]"></span>
            </span>
          ...
          <div className="h-[120px] md:h-[160px] flex flex-col justify-center relative z-20">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h1 className="text-5xl md:text-7xl font-black text-[#01C1D6] tracking-tighter leading-[0.95] relative inline-block">
                  {t(`headlines.${index}.part2`)}
                   {/* Underline decoration */}
                   <svg className="absolute w-full h-3 -bottom-1 left-0 text-[#01C1D6] opacity-60" viewBox="0 0 100 10" preserveAspectRatio="none">
          ...
          <p className="text-lg md:text-xl text-neutral-600 dark:text-neutral-400 leading-relaxed font-medium max-w-lg">
            {t.rich('subtitle', {
              bold: (chunks) => <span className="text-black dark:text-white font-bold decoration-[#01C1D6]/50 underline underline-offset-4 decoration-2">{chunks}</span>
            })}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 w-full sm:w-auto">
            <Button 
              as={Link}
              href="/register"
              className="bg-[#01C1D6] text-white font-black h-14 px-10 text-sm uppercase tracking-widest rounded-full hover:scale-105 transition-transform shadow-xl shadow-[#01C1D6]/25 w-full sm:w-auto"
            >
              {t('startFree')}
            </Button>
            <Button 
        ...
        >
           {/* Glow behind visual */}
           <div className="absolute inset-0 bg-[#01C1D6]/10 blur-[100px] -z-10 rounded-full" />
           ...
           <div className="relative w-full max-w-lg aspect-video bg-neutral-900 rounded-xl border border-neutral-800 shadow-2xl overflow-hidden hidden lg:block transform -rotate-3 hover:rotate-0 transition-transform duration-700">
               ...
               <div className="h-8 bg-neutral-800 border-b border-neutral-700 flex items-center px-4 gap-2">
                  <div className="w-2.5 h-2.5 rounded-full bg-[#01C1D6]" />
